...
<!-- 이미지는 docs/images/ 에 넣습니다. 파일명은 docs/images/README.md 참고. -->

### 첫 화면
![첫 화면](docs/images/01-home.png)

### 사용자 — 서울시 지도
서울시 25개 구 경계 위에 빗물받이 지점을 표시합니다. 점 색이 곧 상태입니다.

![사용자 지도](docs/images/02-user-map.png)

### 사용자 — 지점 상세
선택한 지점의 등급과 내부 적치율을 보여줍니다.

![지점 상세](docs/images/03-user-detail.png)

### 관리자 — 실시간 모니터
판정 결과와 함께 8×8 원본 격자, 통신 품질, 전력 지표를 봅니다.

![관리자 모니터](docs/images/04-admin-monitor.png)

### 관리자 — 수조 내부
zone별 높이를 3D 막대로 그립니다. 센서 위치와 방향도 함께 표시됩니다.

![수조 내부](docs/images/05-admin-tank.png)
